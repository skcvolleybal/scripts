...
class NevoboGateway
{
    ...
    public function GetProgrammaForExternTeam($verenigingscode, $gender, $sequence, $exportType = 'rss')
    {
        $url = sprintf($this->teamprogrammaUrl, $verenigingscode, $gender, $sequence, $exportType);
        return $this->GetProgramma($url);
    }
